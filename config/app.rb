...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'tutorial.com'
  config.app_name = 'Tutorial'
  config.mailer.from = 'Tutorial <no-reply@tutorial.com>'
  ...
  #
  config.app_secret = 'Gl_lmCDtgZbMKt8vJec1b2a4QDFJq4_-Iy3WGO1KBvMF5JXVI_06TexAje5Hc7cyQT0'
